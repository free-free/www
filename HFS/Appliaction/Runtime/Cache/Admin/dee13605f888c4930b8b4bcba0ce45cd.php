...
<head>
	...
	<link rel="stylesheet" href="/HFS/Public/Css/Admin/Safemanage/passMod.css">
	...
	<script src="/HFS/Public/Js/Admin/Safemanage/passmod.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div id="content">
       <h1>修改密码</h1>
       <form id="frm" method="post" action="/HFS/index.php/Admin/Safemanage/passMod">
          <ul class="passmod1">
          ...
          <ul class="passmod4">
             ...
             <li ><img class="code" src="/HFS/index.php/Admin/Safemanage/vcode" alt="vcode" onclick="this.src='/HFS/index.php/Admin/Safemanage/vcode?random=+Math.random()'"></li>
          </ul>
