...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Public/Css/Home/Index/showNews.css">
</head>
<body>
	<div class="header">
		<div class="container">
		...
		<div class="container">
			<div class="l-side-box">
				<div class="related-box">
					<h3>相关新闻</h3>
					<dl>
					  <?php if(is_array($allnewsData)): $i = 0; $__LIST__ = $allnewsData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($i % 2 );++$i;?><dd ><a href="/index.php/Home/Index/showNews?id=<?php echo ($lo["id"]); ?>" class="item"><span><?php echo ($lo["title"]); ?></span></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
				</div>
			</div>
			<div class="r-side-box">
					...
					<?php if(!empty($id)): ?><li class="news-link"><a href="/index.php/Home/Down/newsDownload?id=<?php echo ($id); ?>">请点击下载文件</a></li><?php endif; ?>
					</div>
