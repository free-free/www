		...
		<div class="container">
			<div class="l-side-box">
				<div class="related-box">
					<h3>相关学术报告</h3>
					<dl>
					  <?php if(is_array($allreportData)): $i = 0; $__LIST__ = $allreportData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($i % 2 );++$i;?><dd ><a href="/HFS/index.php/Home/Index/showReport?id=<?php echo ($lo["id"]); ?>" class="item"><span><?php echo ($lo["name"]); ?></span></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
				</div>
			</div>
