		...
		<div class="container">
			<div class="l-side-box">
				<div class="related-box">
					<h3>相关新闻</h3>
					<dl>
					  <?php if(is_array($allnewsData)): $i = 0; $__LIST__ = $allnewsData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($i % 2 );++$i;?><dd ><a href="/HFS/index.php/Home/Index/showNews?id=<?php echo ($lo["id"]); ?>" class="item"><span><?php echo ($lo["name"]); ?></span></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
				</div>
			</div>
