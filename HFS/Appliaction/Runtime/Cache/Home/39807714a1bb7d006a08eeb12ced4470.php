...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/HFS/Public/Css/Home/Index/showReport.css">
</head>
<body>
	<div class="header">
		<div class="container">
		...
		<div class="container">
			<div class="l-side-box">
				<div class="related-box">
					<h3>相关学术报告</h3>
					<dl>
					  <?php if(is_array($allreportData)): $i = 0; $__LIST__ = $allreportData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($i % 2 );++$i;?><dd ><a href="/HFS/index.php/Home/Index/showReport?id=<?php echo ($lo["id"]); ?>" class="item"><span><?php echo ($lo["title"]); ?></span></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>
				</div>
			</div>
			<div class="r-side-box">
					...
					<?php if(!empty($id)): ?><a href="/HFS/index.php/Home/Down/reportDownload?id=<?php echo ($id); ?>">请点击下载文件</a><?php endif; ?>
					</li>
					</div>
